...
public:
  ...
  // If this is true, this event is a key event that was generated by a test. It
  // should be passed down to the child process synchronously if we're using
  // content processes.
  bool mInSyntheticKeyEvent : 1;
