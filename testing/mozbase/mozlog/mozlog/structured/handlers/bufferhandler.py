...
class BufferingLogFilter(object):
    ...
    def message_handlers(self):
        ...
        on - enable buffering for this handler.
        off - disable buffering for this handler.
        flush - log any buffered messages and clear the buffer.
        clear - discard any unwanted messages in the buffer.
        """
        return {
